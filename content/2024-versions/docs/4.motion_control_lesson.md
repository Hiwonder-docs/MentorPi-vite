...
<img class="common_img" src="../_static/media/4.MotionControlLesson/4.1/media/image3.png" style="width:600px"  />
...
The program file is saved in: [ros2_ws/src/driver/controller/controller/mecanum.py](https://store.hiwonder.com.cn/docs/mentorpi/source_code/mecanum.zip)
...
The program files are located in: [ros2_ws/src/driver/controller/controller/ackermann.py](https://store.hiwonder.com.cn/docs/mentorpi/source_code/ackermann.zip)
...
The sixth parameter`start_test` is the button to start testing the odometry angle scale correction.
...
[/home/ubuntu/ros2_ws/src/driver/controller/controller/odom_publisher_node.py](https://store.hiwonder.com.cn/docs/mentorpi/source_code/odom_publisher_node.zip)
...
The launch file is located in: [/home/ubuntu/ros2_ws/src/driver/controller/launch/controller.launch.py](https://store.hiwonder.com.cn/docs/mentorpi/source_code/controller.launch.zip)
...
The Python program is saved in: [/home/ubuntu/ros2 ws/src/driver/controller/controller/odom publisher node.py](https://store.hiwonder.com.cn/docs/mentorpi/source_code/odom_publisher_node.zip)
...
<img class="common_img" src="../_static/media/4.MotionControlLesson/4.5/media/image22.png"   />
...
<img class="common_img" src="../_static/media/4.MotionControlLesson/4.5/media/image28.png"   />
...
The source code for this program can be found at: [/home/ubuntu/ros2_ws/src/driver/controller/controller/odom_publisher_node.py](https://store.hiwonder.com.cn/docs/mentorpi/source_code/odom_publisher_node.zip)
...
The Python program is saved in: [/home/ubuntu/ros2_ws/src/driver/controller/controller/odom_publisher.node.py](https://store.hiwonder.com.cn/docs/mentorpi/source_code/odom_publisher_node.zip)
...
<img class="common_img" src="../_static/media/4.MotionControlLesson/4.6/media/image20.png"   />
...
<img class="common_img" src="../_static/media/4.MotionControlLesson/4.6/media/image26.png"   />
