# MentorPi Documentation

This repository contains the MentorPi VitePress documentation site. The
...
The staged production files are generated in `projects/MentorPi/en/latest/`.
...
```text
https://GITHUB-USERNAME.github.io/MentorPi-vite/projects/MentorPi/en/latest/
```

The public-facing URL (via the baota Nginx reverse proxy) is:

```text
https://wiki-test.hiwonder.com/projects/MentorPi/en/latest/
```
